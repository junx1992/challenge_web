...
def change_json_ann(dataset):
    target_dataset ={}
    target_dataset['info'] = dataset['info']
    target_dataset['images'] = []
    target_dataset['annotations'] = []
    for value in dataset['videos']:
        image_item = {}
        image_item['url'] = value['url']
        image_item['id']  = value['video_id']
        image_item['start time'] = value['start time']
        image_item['end time'] = value['end time']
        image_item['split'] = 'test'
        target_dataset['images'].append(image_item)
    for value in dataset['sentences']:
        sentence_item = {}
        sentence_item['image_id'] = value['video_id']
        sentence_item['id'] = value['sen_id']
        sentence_item['caption'] = value['caption']
        target_dataset['annotations'].append(sentence_item)
    return target_dataset

def change_json_result(result):
    target_result = []
    for value in result['result']:
        item = {}
        item['image_id'] = value['video_id']
...
class COCO:
    def __init__(self, annotation_file=None):
        ...
        if not annotation_file == None:
            ...
            dataset = change_json_ann(dataset)
